---
title: "【AI早读 0710】GPT-5.6 三模型发布：Sol、Terra、Luna 开启高效智能新篇章"
date: 2026-07-10
tags: [GPT-5.6, OpenAI, ChatGPT Work, AI模型, 智能体]
---

![cover](images/ai-daily-2026-07-10.jpg)
...
链接：[The new GPT-5.6 family: Luna, Terra, Sol - Simon Willison](https://simonwillison.net/2026/Jul/9/gpt-5-6/#atom-everything)
...
链接：[GPT-5.6: Frontier intelligence that scales with your ambition - OpenAI](https://openai.com/index/gpt-5-6/)
...
链接：[GPT-5.6 模型使用指南 - OpenAI API Docs](https://developers.openai.com/api/docs/guides/latest-model?model=gpt-5.6)
...
链接：[ChatGPT is now a partner for your most ambitious work - OpenAI](https://openai.com/index/chatgpt-for-your-most-ambitious-work/)
...
链接：[GPT-5.6 is now the preferred model in Microsoft 365 Copilot - OpenAI](https://openai.com/index/gpt-5-6-preferred-model-microsoft-365-copilot)
...
链接：[OpenAI GPT-5.6: AI Could Do Anything, Then It Met ARC-AGI-3 - The Algorithmic Bridge](https://www.thealgorithmicbridge.com/p/openai-gpt-56-ai-could-do-anything)
...
链接：[Introducing GPT-Live - Simon Willison](https://simonwillison.net/2026/Jul/8/introducing-gptlive/#atom-everything)
...
链接：[MCP tool design: Practical approaches and tradeoffs - AWS](https://aws.amazon.com/blogs/machine-learning/mcp-tool-design-practical-approaches-and-tradeoffs/)

Google Research 发布了 `SensorFM`，一个基于超过一万亿分钟的可穿戴传感器数据预训练的基础模型。它学习了通用的人体生理表征，可迁移到 35 种健康预测任务 - 从心血管到代谢、从睡眠到心理健康。

链接：[SensorFM: Towards a general intelligence and interface for wearable health data - Google Research](https://research.google/blog/sensorfm-towards-a-general-intelligence-and-interface-for-wearable-health-data/)
