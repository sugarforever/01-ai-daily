...
Anthropic 发了一篇工程博客，讲他们在三个产品线 - claude.ai、Claude Code、Cowork - 上怎么做 Agent 隔离的。Simon Willison 也在他的博客里做了重点推荐。

原文：[How we contain Claude across products — Anthropic Engineering](https://www.anthropic.com/engineering/how-we-contain-claude)
...
今天另一条重要线索来自 AI Engineer 会议（5/30）。下面这些演讲视频可以看回放：

- [How I deleted 95% of my agent skills and got better results — Nick Nisi](https://www.youtube.com/watch?v=vy7o1g2iHY8)
...
- [How We Built Zeta2 — Ben Kunkle, Zed](https://www.youtube.com/watch?v=phchDt63qAA)

几个演讲都指向同一个方向：**Agent 技能在变多、变杂，但收益在递减。**
...
- **SoftBank** 宣布投资高达 €750 亿建设法国数据中心 - AI 基础设施竞赛延伸到了欧洲，数字很大但要看执行节奏 — [TechCrunch](https://techcrunch.com/2026/05/30/softbank-says-it-will-invest-up-to-e75-billion-to-build-french-data-centers/)
- **OpenRouter** 完成 $1.13 亿 B 轮 - 模型聚合层的资本信号 — [Hacker News](https://news.ycombinator.com/item?id=42193084)
- **Microsoft × NVIDIA** 合作打造专用 AI PC，跑“真正的 Agent”而不仅仅是聊天 - 本地 Agent 推理的硬件化 — [The Decoder](https://the-decoder.com/microsoft-and-nvidia-reportedly-team-up-on-ai-pcs-that-run-actual-agents-instead-of-chatbots/)
- **GitHub Copilot** 启用基于 token 的计费 - 引发开发者社区争议 — [TechCrunch](https://techcrunch.com/2026/05/29/github-copilot-token-based-pricing/)
- **Corporate America starting to ration AI as cost skyrockets** - HN 热帖，大企业开始因为成本限制 AI 用量，和之前的“全力投入”叙事形成了鲜明对比 — [Hacker News](https://news.ycombinator.com/item?id=42190019)
- **Gemini Spark** 实测 - TechCrunch 记者用了一周，结论是“真的能用”，24/7 桌面 AI 助手的实用化评估 — [TechCrunch](https://techcrunch.com/2026/05/30/i-put-googles-247-ai-assistant-gemini-spark-to-work/)
- **Meta 被报道正在开发 AI 挂坠** - 可穿戴 AI 的新尝试 — [TechCrunch](https://techcrunch.com/2026/05/29/meta-is-reportedly-developing-an-ai-pendant/)
